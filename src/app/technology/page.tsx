...
import { techStack as stack } from '@/features/technology/data/technologyData';
            ...
            <div className="lg:col-span-8 space-y-0">
              {[
                ...
                },
                {
                  ...
                  a: 'Yes. We frequently refactor legacy platforms, add features, and optimize performance with thorough documentation.',
                },
                {
                  q: 'What happens after the project ships?',
                  a: 'We offer ongoing maintenance retainers and provide full IP handover with automated tests and team training.',
                },
                {
                  q: 'How do you handle scaling requirements post-launch?',
                  a: 'We engineer systems for headroom from day one, offering quick server scaling and query optimizations on demand.',
                },
                {
                  q: 'Do you work across international time zones?',
                  a: 'Yes. We run asynchronous workflows with guaranteed daily overlap windows for real-time collaboration.',
                },
              ].map((faq, i) => (
                <div
                  key={i}
